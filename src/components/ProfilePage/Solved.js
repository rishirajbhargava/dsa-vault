    ...
    return (
        <div className="solved-question">
            ...
            <div className='solved-title'>
                <a href={ques.URL} target="_blank" rel="noreferrer">{ques.Problem}</a>
            </div>

            <div className='solved-links'>
    

                <a href={ques.URL} target="_blank" rel="noreferrer" >
                ...
                <a href={ques.URL2} target="_blank" rel="noreferrer" >
                    <span> <img src={leetcodePng} alt="leetcode png" /></span>
                </a>
                
                <a title='Go to Question' className="hover-util" href={'/topics/' + ques.topicName} >
